	...
	<form method='post' action='<?php echo $_SERVER["REQUEST_URI"]; ?>'>
		...
		<div style="background-color:#fff;padding:8px;border: 1px solid #CCCCCC;">			
			...
			<tr><td>
				...
				<input type="radio" name="wpeppsubNCX_button_image"  value="6" <?php if(!empty($_POST['wpeppsubNCX_button_image']) == "6") { echo "checked"; } ?> /><img src="https://ssl.nochex.com/Downloads/Nochex Payment Button/cardsboth2.gif" /><br/>
				</td><td></td></tr>
